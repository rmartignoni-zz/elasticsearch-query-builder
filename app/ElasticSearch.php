...
use Monolog\Logger;
use rmartignoni\ElasticSearch\Exceptions\InvalidDocumentException;
use rmartignoni\ElasticSearch\Exceptions\InvalidIndexException;
use rmartignoni\ElasticSearch\Model\Highlight;
